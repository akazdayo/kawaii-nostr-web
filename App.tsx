											...
											<>
												<div className="flex flex-wrap gap-2 justify-center md:justify-start">
													{aiSummary.tags.map((tag, i) => (
														<span
															key={i}
															className="px-4 py-1.5 bg-white/70 rounded-full text-sm font-bold text-gray-600 border border-white shadow-sm hover:bg-white transition-colors cursor-default"
														>
															#{tag}
														</span>
													))}
												...
												<div className="pt-4 border-t border-white/50 flex items-center justify-between">
													...
													<span className="text-2xl font-black text-kawaii-rose">
														{aiSummary.vibe}
													</span>
												</div>
											</>
